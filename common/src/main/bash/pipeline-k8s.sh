...
function logInToPaas() {
	...
	local k8sCaData="${!caData:------BEGIN CERTIFICATE-----
  
  -----END CERTIFICATE-----}"
  	local k8sToken="${!tokenData:-eyJhbGciOiJSUzI1NiIsImtpZCI6IjJGNmRuSldCZFZ1YlZ3OG0wTWJJZG9jdm5uZ2haNFRYM3pmYlM4amJNYmsifQ..hlO5DNWcIeMW7do5JfNWzy1fWrYNH3e4qkEDnYmc4M3ipZGTdUEi7Ml9APvjN36xxw9MHDwaiHcj7HmHxL98lua0zag-1V_e7rLjF_uFqRiEGmUVs4moL2PZa6e75503Oj5z25zpcmzuA7KXivnW_XCUlu1TXMFRPk46xZzoxdIlb6NYPvu3H4w_L8ckxtlzieEdqrM5Ahdq6JQ77LrtwctJ7_0Xxi7O8WNVF760Ew-21N-SttEJWv6wsYUaW_OrBDFWLQdnnlDuf-sIWsHvfGiumqPGPMTcSCdYylk93Ysc8lGCA45ZQDnbKfMviyPLUk9yZLdwwv7MrJfSFpfL8g}"
  	local k8sSystemName="${!systemName:-minikube}"
	############
